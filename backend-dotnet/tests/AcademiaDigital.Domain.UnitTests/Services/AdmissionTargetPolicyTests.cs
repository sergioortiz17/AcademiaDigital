...
public sealed class AdmissionTargetPolicyTests
{
    ...
    {
        var commission = new Division { Id = 20, CareerId = 10, IsActive = true };
    ...
    {
        var commission = new Division { Id = 20, CareerId = 10, IsActive = false };
    ...
    {
        var commission = new Division { Id = 20, CareerId = 11, IsActive = true };
