...
namespace AcademiaDigital.Infrastructure.Migrations
{
    ...
    [Migration("20260906202305_RenameTeachingPositionToCourseSection")]
    partial class RenameTeachingPositionToCourseSection
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AcademiaDigital.Domain.Entities.AttendanceSession", b =>
                {
                    ...
                    b.HasIndex("CourseId", "DivisionId", "AcademicYear", "Semester", "SessionDate", "StartTime", "Scope")
                        .IsUnique();
            ...
            modelBuilder.Entity("AcademiaDigital.Domain.Entities.Gradebook", b =>
                {
                    ...
                    b.HasIndex("CourseId", "DivisionId", "AcademicYear", "Semester")
                        .IsUnique();
