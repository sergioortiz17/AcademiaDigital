...
namespace AcademiaDigital.Infrastructure.Migrations
{
    ...
    [Migration("20260907163010_RelaxGradebookWeightCheckForRecovery")]
    partial class RelaxGradebookWeightCheckForRecovery
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AcademiaDigital.Domain.Entities.AttendanceSession", b =>
                {
                    ...
                    b.HasIndex("CourseSectionId", "SessionDate", "StartTime", "Scope")
                        .IsUnique();
            ...
            modelBuilder.Entity("AcademiaDigital.Domain.Entities.CourseSection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("DivisionId", "CourseId");

                    b.HasIndex("AcademicYear", "Semester", "IsActive");

                    b.ToTable("CourseSections", null, t =>
                        {
                            t.HasCheckConstraint("CK_CourseSections_AssignmentState", "(is_vacant AND teacher_id IS NULL) OR (NOT is_vacant AND teacher_id IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("AcademiaDigital.Domain.Entities.Division", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AcademiaDigital.Domain.Entities.EnrollmentStatusHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<decimal?>("NewFinalGrade")
            ...
            modelBuilder.Entity("AcademiaDigital.Domain.Entities.TeacherCareer", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("TeacherId", "CareerId")
                        .IsUnique();

                    b.ToTable("TeacherCareers", (string)null);
                });
            ...
            modelBuilder.Entity("AcademiaDigital.Domain.Entities.AdmissionForm", b =>
                {
                    ...
                    b.HasOne("AcademiaDigital.Domain.Entities.Division", "Division")
                        .WithMany()
