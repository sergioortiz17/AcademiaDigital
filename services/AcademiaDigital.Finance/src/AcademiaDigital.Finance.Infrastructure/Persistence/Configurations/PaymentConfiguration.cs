...
public sealed class PaymentConfiguration : IEntityTypeConfiguration<Payment>
{
    public void Configure(EntityTypeBuilder<Payment> builder)
    {
        ...
        builder.Property(item => item.StudentName).HasColumnName("student_name").HasMaxLength(200).IsRequired();
        builder.Property(item => item.StudentDni).HasColumnName("student_dni").HasMaxLength(20).IsRequired();
        ...
        // Student / CreatedByUser / ConfirmationRequestedByUser / ConfirmedByUser relations
        // cut on extraction — the ids stay as opaque references.
...
public sealed class PaymentReconciliationConfiguration : IEntityTypeConfiguration<PaymentReconciliation>
{
    public void Configure(EntityTypeBuilder<PaymentReconciliation> builder)
    {
        ...
        // CreatedByUser relation cut on extraction — CreatedByUserId is an opaque reference.
    }
}
